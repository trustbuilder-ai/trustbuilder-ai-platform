...
import type { EnsureChatContextResponse } from "../../../backend_client/types.gen";
...
export function ChallengeDebug() {
  ...
  const challengeContext = useApiData<EnsureChatContextResponse>(ensureChatContextChatContextsEnsurePost, {
    requiresAuth: true,
            ...
            <Flex direction="column" gap="4">
              ...
              {challengeContext.data && (
                <Flex direction="column" gap="5">
                  ...
                  <Box>
                    <Heading size="4" mb="3">Chat Context:</Heading>
                    <Card>
                      <ScrollArea.Root type="auto" style={{ maxHeight: 400 }}>
                        <ScrollArea.Viewport style={{ width: "100%" }}>
                          <Code variant="ghost" size="2" style={{ display: "block", whiteSpace: "pre", fontFamily: "monospace" }}>
                            {JSON.stringify(challengeContext.data.chat_context, null, 2)}
                          </Code>
                        </ScrollArea.Viewport>
                  ...
                  <Box>
                    <Heading size="4" mb="3">Message Tree:</Heading>
                    <Card>
                      <ScrollArea.Root type="auto" style={{ maxHeight: 400 }}>
                        <ScrollArea.Viewport style={{ width: "100%" }}>
                          <Code variant="ghost" size="2" style={{ display: "block", whiteSpace: "pre", fontFamily: "monospace" }}>
                            {JSON.stringify(challengeContext.data.chat_context.message_tree, null, 2)}
                          </Code>
                        </ScrollArea.Viewport>
                        <ScrollArea.Scrollbar orientation="vertical">
                          <ScrollArea.Thumb />

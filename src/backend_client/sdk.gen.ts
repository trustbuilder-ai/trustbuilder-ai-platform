 ...
 */
export const getMessageTreeMessageTreeUserChallengeContextIdGet = <ThrowOnError extends boolean = false>(options: Options<GetMessageTreeMessageTreeUserChallengeContextIdGetData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<GetMessageTreeMessageTreeUserChallengeContextIdGetResponses, GetMessageTreeMessageTreeUserChallengeContextIdGetErrors, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'

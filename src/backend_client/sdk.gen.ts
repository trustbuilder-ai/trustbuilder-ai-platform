 ...
 */
export const deleteChatContextChatContextsChatContextIdDelete = <ThrowOnError extends boolean = false>(options: Options<DeleteChatContextChatContextsChatContextIdDeleteData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).delete<DeleteChatContextChatContextsChatContextIdDeleteResponses, DeleteChatContextChatContextsChatContextIdDeleteErrors, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
 ...
 */
export const listEvaluationsByContextEvaluationsContextChatContextIdGet = <ThrowOnError extends boolean = false>(options: Options<ListEvaluationsByContextEvaluationsContextChatContextIdGetData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<ListEvaluationsByContextEvaluationsContextChatContextIdGetResponses, ListEvaluationsByContextEvaluationsContextChatContextIdGetErrors, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
 ...
 * Raises:
 * HTTPException: 404 if context not found, 403 if user doesn't own context,
 * 422 if request validation fails (missing or invalid leaf_id)
 */
export const evaluateChatContextEvaluationsChatContextsChatContextIdEvaluatePost = <ThrowOnError extends boolean = false>(options: Options<EvaluateChatContextEvaluationsChatContextsChatContextIdEvaluatePostData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<EvaluateChatContextEvaluationsChatContextsChatContextIdEvaluatePostResponses, EvaluateChatContextEvaluationsChatContextsChatContextIdEvaluatePostErrors, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
